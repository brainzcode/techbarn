	...
	return (function () {
			...
			n.timeout = setTimeout(function () {
				if (re(e) && n.cancelled !== true) {
					if (
						!We(
							r,
							xt('hx:poll:trigger', { triggerSpec: r, target: e })
						)
					) {
						t(e);
					}
		...
		function Xt(t, r, n, e, i) {
			...
			if (Dt(e)) {
				...
				var o = e.value;
				if (e.multiple) {
					o = y(e.querySelectorAll('option:checked')).map(function (
						e
					) {
						return e.value;
					});
		...
		function lr(e, t, n, r, i, f) {
			...
			if (O) {
				...
				if (
					q === null ||
					!ee(n, 'htmx:prompt', { prompt: q, target: g })
				) {
					te(c);
					s();
					return d;
